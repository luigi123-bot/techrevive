    ...
    const services = [
        {
            ...
            desc: 'Diseño y despliegue de soluciones escalables en AWS, Azure y Google Cloud. Migración de servidores, bases de datos y seguridad en el cloud.',
            tags: ['AWS', 'Azure', 'DevOps', 'Escalabilidad'],
            color: '#00a8ff',
        },
        {
            id: 'reparacion',
            icon: '🔧',
            title: 'Soporte & Reparación Técnica',
            desc: 'Diagnóstico avanzado y reparación de hardware para PCs y Laptops. Solucionamos fallas críticas, micro-soldadura y recuperación de equipos.',
            tags: ['Reparación', 'Hardware', 'Laptops', 'PC'],
            color: '#ff3366',
        },
        {
            id: 'web-dev',
            ...
            desc: 'Desarrollo de sitios web modernos, rápidos y optimizados para SEO. Desde landing pages hasta complejas aplicaciones web interactivas.',
            tags: ['React', 'Next.js', 'UI/UX', 'Full Stack'],
            color: '#00ff88',
        },
        {
            id: 'ai-automation',
            icon: '🤖',
            title: 'Automatizaciones con IA (n8n)',
            desc: 'Conectamos tus herramientas favoritas usando n8n e Inteligencia Artificial. Optimiza flujos de trabajo y ahorra cientos de horas hombre.',
            tags: ['n8n', 'OpenAI', 'Workflow', 'Automate'],
            color: '#f59e0b',
        },
        {
            id: 'armado',
            icon: '⚙️',
            title: 'Armado Profesional de PCs',
            desc: 'Ensamblaje de estaciones de trabajo y PCs Gamer de alto rendimiento con gestión de cables y optimización de flujo de aire.',
            tags: ['Custom Build', 'Gaming', 'Workstation'],
            color: '#ff00ff',
        },
        {
            id: 'hosting',
            ...
            desc: 'Alojamiento de alto rendimiento con certificados SSL, dominios personalizados y soporte técnico las 24 horas del día.',
            tags: ['Vercel', 'Nginx', 'SSL', 'Support'],
            color: '#a78bfa',
        }
    ];
